...
import {
  ...
  hasClass,
  removeClass
} from "./chunk-XQCEWEAM.js";
import {
  require_prop_types
} from "./chunk-MDVFIVSO.js";
import {
  require_react_dom
...
var divWithClassName_default = (className) => React14.forwardRef((p, ref) => (0, import_jsx_runtime11.jsx)("div", {
  ...p,
  ref,
...
function createWithBsPrefix(prefix, {
  ...
  const BsComponent = React15.forwardRef(({
    className,
    bsPrefix,
    ...
    return (0, import_jsx_runtime12.jsx)(Tag, {
      ref,
...
var Card = React26.forwardRef(({
  ...
  return (0, import_jsx_runtime23.jsx)(Component2, {
    ...
    children: body ? (0, import_jsx_runtime23.jsx)(CardBody, {
      children
    }) : children
  });
});
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = (0, import_react18.useRef)(propValue !== void 0);
  const [stateValue, setState] = (0, import_react18.useState)(defaultValue);
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react18.useCallback)((...args) => {
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react19.useReducer)((state) => !state, false);
  return dispatch;
}
...
function useSafeState(state) {
  const isMounted = useMounted();
  return [state[0], (0, import_react20.useCallback)((nextState) => {
    if (!isMounted())
      return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react21.useRef)(modifiers);
  const popperInstanceRef = (0, import_react21.useRef)();
  const update = (0, import_react21.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react21.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react21.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react21.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react21.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const preventMouseClickOutsideRef = (0, import_react22.useRef)(false);
  const waitingForTrigger = (0, import_react22.useRef)(false);
  const handleMouseCapture = (0, import_react22.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context6 = (0, import_react23.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react23.useRef)(false);
  const {
    flip,
    offset,
    rootCloseEvent,
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react24.default).createContext($b5e257d569688ac6$var$defaultContext);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react24.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react24.useState)(true);
  let value = (0, import_react24.useMemo)(() => ({
  ...
  return (0, import_react24.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, props.children);
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react24.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react24.default).createElement((0, import_react24.default).Fragment, null, props.children);
  }
  return (0, import_react24.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react25.useContext)(DropdownContext_default) || {};
  const handleClick = (0, import_react25.useCallback)((e) => {
    toggle(!show, e);
  }, [show, toggle]);
  const props = {
    id,
...
var Context = (0, import_react26.createContext)(canUseDOM_default ? window : void 0);
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react27.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react27.useRef)(null);
  const focusInDropdown = (0, import_react27.useRef)(false);
  const onSelectCtx = (0, import_react27.useContext)(SelectableContext_default);
  const toggle = (0, import_react27.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  const context6 = (0, import_react27.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  useEventListener((0, import_react27.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false)
    return ref;
  const warningRef = (0, import_react28.useCallback)((refValue) => {
...
var DropdownMenu2 = React38.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react29.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react29.useContext)(DropdownContext_default2);
  align = align || contextAlign;
  const isInputGroup = (0, import_react29.useContext)(InputGroupContext_default);
  const alignClasses = [];
  if (align) {
...
var DropdownToggle2 = React39.forwardRef(({
  ...
  const dropdownContext = (0, import_react30.useContext)(DropdownContext_default);
...
var Dropdown2 = React40.forwardRef((pProps, ref) => {
  ...
  return (0, import_jsx_runtime36.jsx)(DropdownContext_default2.Provider, {
    ...
    children: (0, import_jsx_runtime36.jsx)(Dropdown_default, {
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime36.jsx)(Component2, {
        ...props,
        ref,
...
var DropdownButton = React41.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime38.jsxs)(Dropdown_default2, {
  ref,
  ...props,
...
var Feedback = React42.forwardRef(
  ...
  ({
    ...
    ...props,
    ref,
    className: (0, import_classnames28.default)(className, `${type}-${tooltip ? "tooltip" : "feedback"}`)
  })
);
...
var FormCheckInput = React44.forwardRef(({
  ...
  return (0, import_jsx_runtime40.jsx)(Component2, {
    ...
    type,
    id: id || controlId,
    className: (0, import_classnames29.default)(className, bsPrefix, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormCheck = React46.forwardRef(({
  ...
  return (0, import_jsx_runtime42.jsx)(FormContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime42.jsx)("div", {
      style: style2,
      className: (0, import_classnames31.default)(className, hasLabel && bsPrefix, inline && `${bsPrefix}-inline`, reverse && `${bsPrefix}-reverse`, type === "switch" && bsSwitchPrefix),
...
var FormControl = React47.forwardRef(({
  ...
  return (0, import_jsx_runtime45.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames32.default)(className, classes, isValid && `is-valid`, isInvalid && `is-invalid`, type === "color" && `${bsPrefix}-color`)
  });
});
...
var FormGroup = React48.forwardRef(({
  ...
  const context6 = (0, import_react36.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var FormLabel = React49.forwardRef(({
  ...
  const classes = (0, import_classnames33.default)(className, bsPrefix, visuallyHidden && "visually-hidden", column && columnClass);
  true ? (0, import_warning4.default)(controlId == null || !htmlFor, "`controlId` is ignored on `<FormLabel>` when `htmlFor` is specified.") : void 0;
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime47.jsx)(Col_default, {
      ref,
      as: "label",
      className: classes,
      htmlFor,
...
var FormSelect = React51.forwardRef(({
  ...
  return (0, import_jsx_runtime49.jsx)("select", {
    ...
    size: htmlSize,
    ref,
    className: (0, import_classnames35.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var FormText = React52.forwardRef(
  ...
  ({
    ...
    return (0, import_jsx_runtime50.jsx)(Component2, {
      ...props,
      ref,
      className: (0, import_classnames36.default)(className, bsPrefix, muted && "text-muted")
    });
  }
);
...
var Switch = React53.forwardRef((props, ref) => (0, import_jsx_runtime51.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Form = React55.forwardRef(({
  ...
  ...props,
  ref,
  className: (0, import_classnames38.default)(className, validated && "was-validated")
}));
...
var Container = React56.forwardRef(({
  ...
  return (0, import_jsx_runtime55.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames39.default)(className, fluid ? `${prefix}${suffix}` : prefix)
  });
});
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime58.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime58.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime58.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime58.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = React59.forwardRef(({
  ...
  return (0, import_jsx_runtime58.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
...
var NavItem = React61.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime59.jsx)(Component2, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React62.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime60.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime60.jsx)(NavContext_default.Provider, {
      value: {
        role,
      ...
      children: (0, import_jsx_runtime60.jsx)(Component2, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react44.useRef)(inProp);
  ...
  const child = (0, import_react44.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
function renderTransition(Component2, runTransition, props) {
  if (Component2) {
    return (0, import_jsx_runtime63.jsx)(Component2, Object.assign({}, props));
  }
  if (runTransition) {
...
var Modal = (0, import_react46.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime64.jsx)(import_jsx_runtime65.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime66.jsxs)(import_jsx_runtime65.Fragment, {
...
var AbstractModalHeader = React69.forwardRef(({
  ...
  const context6 = (0, import_react47.useContext)(ModalContext_default);
...
var Modal2 = React71.forwardRef(({
  ...
  const renderBackdrop = (0, import_react48.useCallback)((backdropProps) => (0, import_jsx_runtime71.jsx)("div", {
    ...backdropProps,
...
var NavbarCollapse = React75.forwardRef(({
  ...
  return (0, import_jsx_runtime75.jsx)(Collapse_default, {
...
var OffcanvasToggling = React77.forwardRef(({
  ...
  return (0, import_jsx_runtime77.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
...
var OffcanvasHeader = React78.forwardRef(({
  ...
  return (0, import_jsx_runtime78.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime79.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React79.forwardRef(({
  ...
  const {
    onToggle
  } = (0, import_react54.useContext)(NavbarContext_default) || {};
  ...
  const renderBackdrop = (0, import_react54.useCallback)((backdropProps) => (0, import_jsx_runtime79.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime81.jsxs)(import_jsx_runtime80.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime79.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React80.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime82.jsx)(Offcanvas_default, {
    ref,
...
var Popover = React85.forwardRef(({
  ...
  return (0, import_jsx_runtime87.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime86.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime86.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react59.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React87.forwardRef(({
  ...
  return (0, import_jsx_runtime90.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime93.jsxs)(import_jsx_runtime92.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react61.cloneElement)(children, triggerProps), (0, import_jsx_runtime91.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React89.forwardRef(({
  ...
  return (0, import_jsx_runtime94.jsx)("li", {
    ...
    children: (0, import_jsx_runtime95.jsxs)(Component2, {
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React89.forwardRef(({
    children,
    ...props
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react63.useContext)(TabContext_default);
  if (!context6)
    ...
    return (0, import_jsx_runtime106.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime106.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime106.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime106.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime111.jsx)(import_jsx_runtime110.Fragment, {});
};
...
var Table = React104.forwardRef(({
  ...
  const table = (0, import_jsx_runtime112.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
var ToastFade = React106.forwardRef((props, ref) => (0, import_jsx_runtime115.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React108.forwardRef(({
  ...
  const context6 = (0, import_react65.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var Toast = React109.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime118.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime118.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime118.jsx)(Transition, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
...
var ToggleButton = React111.forwardRef(({
  ...
  return (0, import_jsx_runtime122.jsxs)(import_jsx_runtime121.Fragment, {
    children: [(0, import_jsx_runtime120.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime120.jsx)(Button_default2, {
      ...props,
      ref,
...
var ToggleButtonGroup = React112.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime123.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
