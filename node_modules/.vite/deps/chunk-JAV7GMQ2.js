...
function useDropdownItem({
  ...
  const onSelectCtx = (0, import_react3.useContext)(SelectableContext_default);
  const navContext = (0, import_react3.useContext)(NavContext_default);
  const {
    activeKey
  } = navContext || {};
...
var Anchor = React5.forwardRef((_ref, ref) => {
  let {
    onKeyDown
...
function useBootstrapPrefix(prefix, defaultPrefix) {
  const {
    prefixes
  } = (0, import_react15.useContext)(ThemeContext);
...
react/cjs/react-jsx-runtime.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JAV7GMQ2.js.map
